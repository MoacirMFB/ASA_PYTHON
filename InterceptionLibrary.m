    ...
    methods
        ...
        function ast = propagateAsteroids(obj, ast, env)
            ...
            for k = 1:numel(ast)
                ...
                % [r0_ijk_km, v0_ijk_km_s] = keplerian2ijk( ...
                %     coe_k(1), ...
                %     coe_k(2), ...
                %     rad2deg(coe_k(3)), ...
                %     rad2deg(coe_k(4)), ...
                ...
                [r0_ijk_m, v0_ijk_m_s] = keplerian2ijk( ...
                    1000 * coe_k(1), ...
                    coe_k(2), ...
                    rad2deg(coe_k(3)), ...
                    rad2deg(coe_k(4)), ...
                    ...
                    rad2deg(coe_k(6)), ...
                    'CentralBody', 'Sun');
                X0 = [r0_ijk_m(:) / 1000; v0_ijk_m_s(:) / 1000];

                % X0 = obj.orb.coe_to_cartesian(coe_k, obj.MU_SUN_KM, 'useTA', true);
